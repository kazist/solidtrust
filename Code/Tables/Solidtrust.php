...
namespace Solidtrust\Payments\Solidtrust\Code\Tables;
 ...
 * Solidtrust
 *
 * @ORM\Table(name="solidtrust_payments_solidtrust", indexes={@ORM\Index(name="created_by_index", columns={"created_by"}), @ORM\Index(name="modified_by_index", columns={"modified_by"})})
 * @ORM\Entity
 * @ORM\HasLifecycleCallbacks
 */
class Solidtrust extends \Kazist\Table\BaseTable {
